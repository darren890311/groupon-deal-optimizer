"""High-level parse: turn a Groupon deal HTML page into a structured audit dict.

All field-level extractors live in src.parse_helpers. This module is the
orchestrator and the mobile-vs-desktop comparator.
"""
